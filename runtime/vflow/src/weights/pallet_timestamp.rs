...
//! HOSTNAME: `5eb726f9fed0`, CPU: `AMD Ryzen 7 7700 8-Core Processor`
...
// --output
// /data/benchmark/runtime/vflow/src/weights/pallet_timestamp.rs
// --template
...
impl<T: frame_system::Config> pallet_timestamp::WeightInfo for ZKVEvmWeight<T> {
    ...
    fn set() -> Weight {
        ...
        Weight::from_parts(10_500_000, 1493)
